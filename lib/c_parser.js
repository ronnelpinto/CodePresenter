function c_beautify(js_source_text, options) {
   ...
   // alert(options.indent_size);

    var opt_indent_size = options.indent_size ? parseInt(options.indent_size, 10):4,
...
if (typeof define === "function" && define.amd) {
        ...
        define([], function() {
            return { c_beautify: c_beautify };
        });
    } else if (typeof exports !== "undefined") {
        // Add support for CommonJS. Just put this file somewhere on your require.paths
        // and you will be able to `var c_beautify = require("beautify").c_beautify`.
        exports.c_beautify = c_beautify;
    } else if (typeof window !== "undefined") {
        // If we're running a web page and don't have either of the above, add our one global
        window.c_beautify = c_beautify;
    } else if (typeof global !== "undefined") {
        // If we don't even have window, try global.
        global.c_beautify = c_beautify;
}